            ...
            <div>
                <div className="card justify-content-center">
                    <form className="flex flex-col gap-[2rem]" onSubmit={isForUpdate ? updateuser : handleSubmit}>
                        ...
                        />
                        <select name="role" id="role" required onChange={handleChange} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 border border-custom-red rounded py-2 px-3 outline-none">
