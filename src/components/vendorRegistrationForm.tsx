                    ...
                    <form onSubmit={isForUpdate ? updateVendor : handleSubmit}>
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="businessBrandName" onChange={handleChange} defaultValue={vendorData.businessBrandName} className="bg-gray-50 border border-custom-gray-3 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-custom-gray-5 dark:border- dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Business Brand Name" />
                            </div>
                            <div>
                                <label htmlFor="gstIn" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">GSTIN</label>
                                <input type="text" id="gstIn" onChange={handleChange} defaultValue={vendorData.gstin} className="bg-gray-50 border border-custom-gray-3 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-custom-gray-5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" pattern="[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}[Z]{1}[0-9]{1}" placeholder="GSTIN" />
                            </div>
                            <div>
