...
import { Quotation, QuotationRequestStatus, QuotationStatus } from '@prisma/client';
...
const page = async (context: any) => {
    ...
    if (quotationRequest?.status === QuotationRequestStatus.ACTIVE) {
        quotationRequest.products = [...quotationRequest.products, ...getArrayWithIndividualElements(activeQuotationsOfSameVendor.map((quotation: any) => quotation.products))];
